...
```{r plots,echo=FALSE}
plot(formula = pool$residuals ~ s$inzidenz1, xlab = "inzidenz", ylab = "Residuen", cex.axis = 0.8)
plot(formula = pool$residuals ~s$weightednbinz1 , xlab = "weightednbinz1", ylab = "Residuen", cex.axis = 0.8)
plot(formula = pool$residuals ~ s$density_inzidenz1, xlab = "density_inzidenz1", ylab = "Residuen", cex.axis = 0.8)
plot(formula = pool$residuals ~ s$hotspot_inzidenz1, xlab = "hotspot_inzidenz1", ylab = "Residuen", cex.axis = 0.8)
plot(formula = pool$residuals ~ s$hotspotnb_wnbinzidenz1, xlab = "hotspotnb_wnbinzidenz1", ylab = "Residuen", cex.axis = 0.8)
plot(formula = pool$residuals ~ s$zweitimpf_hotspot, xlab = "zweitimpf_hotspot", ylab = "Residuen", cex.axis = 0.8)
