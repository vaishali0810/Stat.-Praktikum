...
## ???? plot komisch
plot(formula = pool.sqrt$residuals ~ s$A60.79.Anteil, xlab = "A60.79.Anteil", ylab = "Residuen", cex.axis = 1.5, pch=16, cex.lab= 1.5,
     bg="black", col=alpha("black",0.2), pch=16)+ abline(h = 0, col = adjustcolor("black",alpha=0.5), lwd = 3, lty = "longdash")
