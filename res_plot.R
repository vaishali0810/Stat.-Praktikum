...
plot(formula = fe6$residuals ~ t$A15.34.Anteil, xlab = "A15.34.Anteil", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für A15.34.Anteil")

plot(formula = fe6$residuals ~ t$density_inzidenz1, xlab = "density_inzidenz1", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für density_inzidenz1")

plot(formula = fe6$residuals ~ t$A60.79.Anteil, xlab = "A60.79.Anteil", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für A60.79.Anteil")

plot(formula = fe6$residuals ~ t$rate_zweitimpf, xlab = "rate_zweitimpf", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für rate_zweitimpf")

plot(formula = fe6$residuals ~ t$rate_drittimpf, xlab = "rate_drittimpf", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für rate_drittimpf")

plot(formula = fe6$residuals ~ t$rate_viertimpf, xlab = "rate_viertimpf", ylab = "Residuen", cex.axis = 0.8, cex = 0.4) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot fü rate_viertimpf")
...
plot(formula = fe6$residuals ~ t$rate_viertimpf, xlab = "rate_viertimpf", ylab = "Residuen", cex.axis = 0.8, cex = 0.7) + abline(h = 0, col = "red", lwd = 2)+ title("Residuen Plot für rate_viertimpf")
