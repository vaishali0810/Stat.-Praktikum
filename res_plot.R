...
plot(formula = fe6$residuals ~ t$inzidenz2, xlab = "inzidenz", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~t$weightednbinz2 , xlab = "weightednbinz2", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~t$A05.14.Anteil , xlab = "A05.14.Anteil", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$A15.34.Anteil, xlab = "A15.34.Anteil", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$density_inzidenz1, xlab = "density_inzidenz1", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$A60.79.Anteil, xlab = "A60.79.Anteil", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$rate_zweitimpf, xlab = "rate_zweitimpf", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$rate_drittimpf, xlab = "rate_drittimpf", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)

plot(formula = fe6$residuals ~ t$rate_viertimpf, xlab = "rate_viertimpf", ylab = "Residuen", cex.axis = 0.8) + abline(h = 0, col = "red", lwd = 2)
